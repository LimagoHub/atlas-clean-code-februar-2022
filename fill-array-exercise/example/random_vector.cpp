...
public:
    ...
    auto run() const -> void
    {
        // TODO(2022-02-24 by wolters): Remove hard dependency.
...
private:
    // TODO(2022-02-24 by wolters): Find better name.
    auto createVectorAndTimeMeasureAndDebugPrint(std::size_t const currentWorker) const -> void
    {
        // TODO(2022-02-24 by wolters): Adding a factory would allow to inject this too.
...
auto run() -> int
{
    ...
    // TODO(2022-02-23 by wolters): Consider usage of a function decorator.
