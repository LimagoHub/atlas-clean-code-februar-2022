...
public:
    // TODO(2022-02-23 by wolters): Consider usage of strong type instead of `std::size_t` for `workerCount`.
    ...
    [[nodiscard]] auto create(std::size_t const elementCount) const -> std::vector<std::int32_t> override
    {
        ...
        // TODO(2022-02-24 by wolters): Extract threads to separate class.
...
private:
    ...
    {
        // TODO(2022-02-23 by wolters): Use `narrow_cast` when available or implement it.
        // TODO(2022-02-23 by wolters): This does not respect all container elements. Use module for the calculation of
